...
/* --- Mapeamento OpenWeatherMap icon code -> componente --- */
export function getWeatherIcon(iconCode: string, size = 48) {
  // Codigos OpenWeatherMap: https://openweathermap.org/weather-conditions
  ...
  switch (code) {
    ...
    case "09":
      return <HeavyRainIcon size={size} />;
    case "10":
